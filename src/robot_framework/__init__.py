"""This is the robotframework plugin for Auto-GPT plugins."""
import abc
...
# class AutoGPTRobotframework(AbstractSingleton, metaclass=Singleton):
class AutoGPTRobotframework(AutoGPTPluginTemplate):
    """
    This is the robotframework plugin for Auto-GPT plugins.
    """
    ...
    def __init__(self):
        super().__init__()
        self._name = "Auto-GPT-Robotframework-Plugin"
        self._version = "0.1.0"
        self._description = "Auto-GPT Robotframework Plugin: Run robotframework Scripts."
